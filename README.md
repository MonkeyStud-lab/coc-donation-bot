...
Python ADB-driven Clash of Clans clan donation bot for **Waydroid on Ubuntu**. Uses OpenCV template matching and OCR to detect clan chat donation requests and automatically donate troops, spells, and siege machines.
...
3. Follow the prompts to capture ROIs, UI templates, slot colors, and unit icons
...
- [`config/default.yaml`](config/default.yaml) — defaults, unit registry, timing
...
| OCR misreads quantities | Recapture unit templates at higher resolution |
