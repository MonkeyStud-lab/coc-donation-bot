...
class InventoryParser:
    ...
    def parse_slots(
        ...
        *,
        ...
        for bar_roi_key, _grid_key, default_category in self.BAR_CONFIGS:
        ...
        if not slots and not stop_at_grey:
            self._log_empty_inventory_hint()
        return slots
    ...
    def _log_empty_inventory_hint(self) -> None:
        ...
        logger.warning(
            "No colored donatable slots detected (troop_bar={}, spell_bar={}, color_calibrated={})",
            troop_roi,
            spell_roi,
            has_color_refs,
        )
