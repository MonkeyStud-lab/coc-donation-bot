...
| Setup | Calibration checklist; in-app pickers for tap/ROI/template; classic terminal for colors/grid/full runs; backup/restore snapshots under `data/calibration_backups/` |
